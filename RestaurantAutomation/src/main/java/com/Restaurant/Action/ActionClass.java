...
public class ActionClass extends BaseClass 
{
	...
	public void MoveToclick(WebDriver driver, WebElement ele) {
	...
	public boolean switchToFrameByIndex(WebDriver driver,int index) {
		boolean flag = false;
		try {
			new WebDriverWait(driver, Duration.ofSeconds(index)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//iframe")));
